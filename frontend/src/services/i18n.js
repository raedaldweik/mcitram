...
const STR = {
  ...
  execReport: { en: 'Executive report', ar: 'تقرير تنفيذي' },
  reportRecommendations: { en: 'Recommendations', ar: 'التوصيات' },
  reportGeneratedBy: { en: 'Generated by the MCIT Commodity Demand Copilot', ar: 'أُعدّ بواسطة مساعد توقعات الطلب على السلع' },
